...
export const DEFAULT_SETTINGS: AppSettings = {
  ...
  layout: {
    ...
    leftWidth: 280,
    rightWidth: 320,
    // Mirrors the TUI: files/quicknote/todo left, backlinks/graph/calendar right.
    left: [
      { id: 'files', visible: true, collapsed: false, height: 0 },
      { id: 'bookmarks', visible: false, collapsed: false, height: 160 },
      { id: 'quicknote', visible: true, collapsed: false, height: 170 },
      { id: 'todo', visible: true, collapsed: false, height: 240 },
    ],
    right: [
      { id: 'backlinks', visible: true, collapsed: false, height: 0 },
      { id: 'outline', visible: false, collapsed: false, height: 200 },
      { id: 'tags', visible: false, collapsed: false, height: 200 },
      { id: 'properties', visible: false, collapsed: false, height: 200 },
      { id: 'graph', visible: true, collapsed: false, height: 260 },
