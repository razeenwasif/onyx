...
pub const GLOSSARY: &[KeyHelp] = &[
    ...
    KeyHelp { keys: "v",           action: "Visual line select",       group: "Editor (Normal)" },
    KeyHelp { keys: "p / P",       action: "Paste yank below / above", group: "Editor (Normal)" },
    KeyHelp { keys: "j/k motions", action: "Extend selection",         group: "Editor (Visual)" },
    KeyHelp { keys: "y / d",       action: "Yank / delete selection",  group: "Editor (Visual)" },
    KeyHelp { keys: "r",           action: "AI-rewrite selection (or :rewrite <instr>)", group: "Editor (Visual)" },
    KeyHelp { keys: "v / Esc",     action: "Leave Visual mode",        group: "Editor (Visual)" },
